...
### Track 1 shipped 2026-04-23 — D1/D2/D3/D4c closed (4 of 6)

Formulas extracted from WS.xlsm cell formulas on 2026-04-23 and
wired to backend in commit `7c02458`. See
`HARDCODED_VALUES_TRACE.md` §6 for the full verification ledger.
